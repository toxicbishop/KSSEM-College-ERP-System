...
import (
	...
	"github.com/toxicbishop/kssem-college-erp-system/services/academic/internal/handlers"
...
func main() {
	...
	logger.Info(ctx, "Starting Academic Service", "port", port)
	...
	// Register Service
	srv := handlers.NewAcademicServer(firestoreClient, rdb)
	pb.RegisterAcademicServiceServer(grpcServer, srv)
	...
	go func() {
		...
		healthPort := "8083" // Different port for health check
